...
# %% auto 0
__all__ = ['Data', 'get_g12d', 'get_kseq']
...
# %% ../nbs/03_dataset.ipynb 13
def get_kseq():
    "sequence of kras and its mutation g12d and g12c "
    df = pd.read_csv("https://github.com/sky1ove/tools/raw/main/dataset/KRAS_seq.csv")
    print(df.shape, df.columns.tolist())
    return df
